module immediate_generator_b_extender (
    ...
    genvar i;
    generate
        for (i = 0; i < 16; i = i + 1) begin : gen_b_ext
            // B-type(Branch)即値は命令の[15:4]（w_padded_bitsの[11:0]）に位置する
            // 符号ビットは即値フィールドの最上位である w_padded_bits[11]
            immediate_generator_sign_ext_bit u_bit (
                .i_raw_bit  ((i < 12) ? w_padded_bits[i] : 1'b0),
                .i_sign_bit (w_padded_bits[11]),
                .i_use_sign (i >= 12),
